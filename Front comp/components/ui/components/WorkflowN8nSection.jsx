/*
=========================================================
SETOR 1 — SEÇÃO DO FLUXO N8N
Essa página explica visualmente o pipeline do sistema.
=========================================================
*/
    ...
    <section id="fluxo" className="py-5 bg-white border-top border-bottom">
      <Container>
        <div className="text-center mb-5">
          <Badge bg="dark" className="mb-2">Fluxo automatizado</Badge>
        ...
        <Row className="g-4">
          {pipelineCards.map(({ icon: Icon, title, text }) => (
